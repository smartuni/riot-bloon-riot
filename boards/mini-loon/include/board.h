...
#define SX127X_PARAM_DIO1               GPIO25 /* Pin is not connected to the LoRa chip directly */
#define SX127X_PARAM_DIO2               GPIO26 /* Pin is not connected to the LoRa chip directly */
